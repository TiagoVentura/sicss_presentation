...
- Flipped Classroom
    ...
    - **[Vídeos](https://sicss.io/curriculum)** das aulas devem ser assistidos com antecedência. 
...
- A Base dos Dados com Ricardo Dahis.

- Automated Text Analysis with Spacy and LDAviz com Lucas Roberto.
...
Depende de você e dos seus coleges continuar a trabalhar nos projetos pós-SICSS. 

Buscaremos financiamento para os projetos iniciados no SICSS DAPP FGV.

Você pode escolher seus grupos. Facilitaremos a geração de ideias de projeto usando um processo para reunir pessoas em pequenos grupos com base nos interesses mais semelhantes e mais diferentes. 


Você poderá então ativar as ideias. Recomendamos grupos de 2 a 6 pessoas. 
...
Faremos em breve uma dinâmica mais longa de apresentações.
...
- Ajude o colega e esteja aberto a ser ajuda. 
...
Quando possível, tenha seu vídeo ativo
...
- Tente usar sua voz para responder a perguntas de discussão em grupo.
...
Use o canal #dapp-fgv o quanto quiser para falar com os participantes
