...
knitr::kable(head(final), format = 'html')
```
---
...
Clique no link do google doc do seu site aqui: [Lista de Idéias](https://docs.google.com/document/d/19FlGXkPEALTKPEO5i87IjsSxMTb34oVTUlsyeuYnKF0/edit)
